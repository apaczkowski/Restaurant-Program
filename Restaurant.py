...
def report_products():
    query = "SELECT ProductID, ProductName, RestaurantID, MenuPrice, Points, FoodType, Menu, ROUND((MenuPrice / Points * 100), 4) AS PriceToPoints FROM Product WHERE 1=1"
    params = []
